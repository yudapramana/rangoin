                                    ...
                                    <form action="{{route('posts.update', $post->id)}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <button type="button" id="cover_image_url_btn" class="btn btn-secondary btn-sm" @if($post->cover) style="display:none;" @else style="display:block;" @endif>Unggah Cover</button>

                                                <div class="show-cover-box" @if($post->cover) style="display:block;" @else style="display:none;" @endif >
                                                    <img class="mb-2" id="preview-cover" src="{{$post->cover}}" alt="logo_instansi" height="200"><br>
                                                    <div class="mb-2">
                                                        <button type="button" id="retry-cover-btn" class="btn btn-secondary btn-sm">Hapus & Unggah Ulang</button>
                                                    </div>
                                                </div>
                                            </div>@error('cover')
